...
namespace quanliquancoffee.frm
{
    public partial class frmAccountProfile : Form
    {
        ...
        void UpdateAccountInfo()
        {
            ...
            {
                if (AcountDAO.Instance.UpdateAccount(userName, displayName, password, newpass))
                {
                    MessageBox.Show("Cập nhật thành công");
                   if (updateAccount != null)
                        updateAccount(this, new AccountEvent(AcountDAO.Instance.GetAccountByUserName(userName)));
                }
                else
                {
